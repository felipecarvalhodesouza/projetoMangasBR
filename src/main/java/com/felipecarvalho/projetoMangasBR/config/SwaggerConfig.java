...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.felipecarvalho.projetoMangasBR.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo( 
				...
				new Contact(
					...
					"https://github.com/felipecarvalhodesouza",
					"desouzafelipecarvalho@gmail.com"),
				"LinkedIn",
				"https://www.linkedin.com/in/desouzafelipecarvalho/",
